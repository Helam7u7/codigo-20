...
console.log(`Total películas: ${totalDePeliculas()}`);

//> Ejercicio 2
//> Función que retorna el mayor vistas en películas
//> Campo a analizar _popularity_ 
//> Iterar todas las películas guardando:
//> 1. el index o posición de la película con mayor popularidad 
...
function peliculaConMayorPopularidad() {
  ...
  // console.log('mayor popularidad', mayorPopularidad);
  // console.log('posición de mayor popularidad', posicionMP);
  return peliculas[posicionMP].title;
}

// peliculaConMayorPopularidad();
...
console.log('Genertos de la película 0', peliculas[0].title);
